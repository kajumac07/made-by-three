    ...
    >
      ...
      <div className="max-w-5xl mx-auto mb-24 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex justify-center">
          <div className="relative w-80 h-80 rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-white">
            <img
            ...
            <div className="absolute bottom-4 left-4 bg-white/90 px-4 py-2 rounded-xl text-sm text-gray-900 font-semibold shadow-lg">
              United by Passion
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex flex-col items-center p-8">
                <div className="relative mb-4">
                  ...
                  />
                  <span className="absolute -bottom-2 -right-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-3 py-1 text-xs rounded-full font-semibold shadow-md">
                    {member.experience}
                  </span>
                </div>
                <h4 className="text-2xl font-bold mb-1 text-gray-900">
                  {member.name}
                </h4>
                ...
                <div className="flex justify-center gap-3 mt-2">
                  ...
                  {member.socials.instagram && (
                    <a
                      ...
                      className="p-2 rounded-full bg-gray-100 hover:bg-pink-100 text-gray-700 hover:text-pink-700 transition-colors"
      ...
      <div className="max-w-6xl mx-auto mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {skillCategories.map((category, i) => (
            <div
              key={i}
              className="bg-white border border-gray-100 rounded-2xl shadow-lg p-8 flex flex-col items-center hover:shadow-xl transition-all"
            >
              <div
